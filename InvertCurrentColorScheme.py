...
class InvertCurrentColorSchemeCommand(sublime_plugin.TextCommand):
	...
	def run(self, edit):
		...
		print('Updating preferences file with color scheme:' + self.inverted_scheme_path_formatted_for_preferences_file())
		prefs.set('color_scheme', self.inverted_scheme_path_formatted_for_preferences_file())
